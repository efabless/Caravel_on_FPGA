...
## Buttons
set_property PACKAGE_PIN A18     [get_ports { RST }]; #IO_L19N_T3_VREF_16 Sch=btn[0]
...
set_property PACKAGE_PIN C15 [get_ports {fcen}]; #IO_L11P_T1_SRCC_16 Sch=pio[05]
set_property PACKAGE_PIN H1  [get_ports {fsclk}]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
#set_property PACKAGE_PIN H1  [get_ports {signal}]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
set_property PACKAGE_PIN A15 [get_ports {fdio[0]}]; #IO_L6N_T0_VREF_16 Sch=pio[07]
...
set_property PACKAGE_PIN A14 [get_ports {fdio[1]}]; #IO_L6P_T0_16 Sch=pio[09]
#set_property PACKAGE_PIN A14 [get_ports {signal}]; #IO_L6P_T0_16 Sch=pio[09]
set_property PACKAGE_PIN J3  [get_ports {fdio[2]}]; #IO_L7P_T1_AD6P_35 Sch=pio[10]
#set_property PACKAGE_PIN J3  [get_ports {signal}]; #IO_L7P_T1_AD6P_35 Sch=pio[10]
set_property PACKAGE_PIN J1  [get_ports {fdio[3]}]; #IO_L3N_T0_DQS_AD5N_35 Sch=pio[11]
...
## UART
set_property PACKAGE_PIN J18 [get_ports { UART_MASTER_TX }]; #IO_L7N_T1_D10_14 Sch=uart_rxd_out
set_property PACKAGE_PIN J17 [get_ports { UART_MASTER_RX }]; #IO_L7P_T1_D09_14 Sch=uart_txd_in
