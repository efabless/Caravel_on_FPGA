...
#set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS33 } [get_ports { mprj_io[36] }]; #IO_L8P_T1_D11_14 Sch=ja[4]
#set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { mprj_io[37] }]; #IO_L5P_T0_D06_14 Sch=ja[7]
...
set_property -dict { PACKAGE_PIN P3    IOSTANDARD LVCMOS33 } [get_ports { mprj_io[7] }]; #IO_L12N_T1_MRCC_35 Sch=pio[19]
set_property -dict { PACKAGE_PIN M2    IOSTANDARD LVCMOS33 } [get_ports { mprj_io[8] }]; #IO_L9P_T1_DQS_AD7P_35 Sch=pio[20]
set_property -dict { PACKAGE_PIN N1    IOSTANDARD LVCMOS33 } [get_ports { mprj_io[9] }]; #IO_L10N_T1_AD15N_35 Sch=pio[21]
set_property -dict { PACKAGE_PIN N2    IOSTANDARD LVCMOS33 } [get_ports { mprj_io[10] }]; #IO_L10P_T1_AD15P_35 Sch=pio[22]
