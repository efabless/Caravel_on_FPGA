...
#set_property -dict { PACKAGE_PIN J5    IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[13] }]; #IO_25_35 Sch=led[5]
#set_property -dict { PACKAGE_PIN T9    IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[14] }]; #IO_L24P_T3_A01_D17_14 Sch=led[6]
#set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[15] }]; #IO_L24N_T3_A00_D16_14 Sch=led[7]
...
# set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[34] }]; #IO_L23P_T3_FOE_B_15 Sch=jb_p[3]
# set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[35] }]; #IO_L23N_T3_FWE_B_15 Sch=jb_n[3]
# set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[36] }]; #IO_L24P_T3_RS1_15 Sch=jb_p[4]
# set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[37] }]; #IO_L24N_T3_RS0_15 Sch=jb_n[4]

## Pmod Header JC
# set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[38] }]; #IO_L20P_T3_A08_D24_14 Sch=jc_p[1]
# set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[39] }]; #IO_L20N_T3_A07_D23_14 Sch=jc_n[1]
# set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[41] }]; #IO_L21P_T3_DQS_14 Sch=jc_p[2]
# set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[42] }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=jc_n[2]
# set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[43] }]; #IO_L22P_T3_A05_D21_14 Sch=jc_p[3]
# set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[44] }]; #IO_L22N_T3_A04_D20_14 Sch=jc_n[3]
# set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[45] }]; #IO_L23P_T3_A03_D19_14 Sch=jc_p[4]
...
# set_property -dict { PACKAGE_PIN D2    IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[47] }]; #IO_L14N_T2_SRCC_35 Sch=jd[8]
# set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { pin_mux_io[47] }]; #IO_L15P_T2_DQS_35 Sch=jd[9]
...
## Quad SPI Flash
# set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS33 } [get_ports { fcen }]; #IO_L6P_T0_FCS_B_14 Sch=qspi_cs
# set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports { fdio[0] }]; #IO_L1P_T0_D00_MOSI_14 Sch=qspi_dq[0]
# set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { fdio[1] }]; #IO_L1N_T0_D01_DIN_14 Sch=qspi_dq[1]
# set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { fdio[2] }]; #IO_L2P_T0_D02_14 Sch=qspi_dq[2]
# set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { fdio[3] }]; #IO_L2N_T0_D03_14 Sch=qspi_dq[3]
# set_property -dict { PACKAGE_PIN E9 IOSTANDARD LVCMOS33 } [get_ports { fsclk }];
